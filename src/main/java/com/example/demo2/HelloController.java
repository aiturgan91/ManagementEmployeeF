...
public class dashboardController implements Initializable {
    ...
    @FXML
    private TableView<DataBase> addEmployee_tableView;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_employeeID;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_firstName;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_lastName;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_gender;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_phoneNum;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_position;

    @FXML
    private TableColumn<DataBase, String> addEmployee_col_date;
    ...
    @FXML
    private TableView<DataBase> salary_tableView;

    @FXML
    private TableColumn<DataBase, String>
        ...
        addEmployee_search.textProperty().addListener((Observable, oldValue, newValue) -> {
            ...
            filter.setPredicate(predicateEmployeeData -> {
                ...
                if (predicateEmployeeData.getEmployeeId().toString().contains(searchKey)) {
                    return true;
                } else if (predicateEmployeeData.getF().toLowerCase().contains(searchKey)) {
                    return true;
    ...
    public ObservableList<EmployeeData> addEmployeeListData() {
        ...
        try {
            ...
            while (result.next()) {
                employeeD = new (result.getInt("employee_id"),
    ...
    private ObservableList<Employeetype> addEmployeeList;
    ...
    public void addEmployeeSelect() {
        Employeetype employeeD = addEmployee_tableView.getSelectionModel().getSelectedItem();
